...
def overlay(beats: list[Beat], game: BestGame, highlight_len: int = 50) -> list[Snapshot]:
    ...
    # start_beats_index = best_beat_index - (highlight_len // 2)
    # end_beats_index = best_beat_index + (highlight_len // 2)
    # start_highlight_index = best_game_index - (highlight_len // 2)
    # end_highlight_index = best_game_index + (highlight_len // 2)
